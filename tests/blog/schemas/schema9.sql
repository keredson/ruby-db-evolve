...
REVOKE ALL ON TABLE blog1 FROM db_evolve_test;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE blog1 TO db_evolve_test;
REVOKE ALL ON TABLE blog2 FROM PUBLIC;
REVOKE ALL ON TABLE blog2 FROM db_evolve_test;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE blog2 TO db_evolve_test;
REVOKE ALL ON TABLE blog3 FROM PUBLIC;
REVOKE ALL ON TABLE blog3 FROM db_evolve_test;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE blog3 TO db_evolve_test;
REVOKE ALL ON TABLE blog4 FROM PUBLIC;
REVOKE ALL ON TABLE blog4 FROM db_evolve_test;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE blog4 TO db_evolve_test;
